#===============================================================================
#================= Gibbs Sampling for Rider Drop-off Locations =================
#===============================================================================
...
#' Bayesian model that assumes the rider drop-off locations are distributed from 
...
inits <- list(list(mu=c(0, 0), Omega=matrix(c(0.01,0,0,0.01), nrow=2, ncol=2)), 
              ...
              list(mu=c(11, 13.5), Omega=matrix(c(0.1,0,0,0.1), nrow=2, ncol=2)))
